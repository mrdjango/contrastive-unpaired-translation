...
from .revised_patchnce import TangentPatchNCELoss
...
class CUTModel(BaseModel):
    ...
    def data_dependent_initialize(self, data):
        """Initialize model after first batch is provided."""
    ...
    def calculate_NCE_loss(self, src, tgt):
        """Calculate NCE loss with tangent distance."""
